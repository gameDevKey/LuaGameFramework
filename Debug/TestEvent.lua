...
EventManager.Instance():Broadcast(EEvent.Type.EventA, EEvent.Type.EventA, "测试事件广播")

print("广播 EEvent.Type1.EventA1")
EventManager.Instance():Broadcast(EEvent.Type1.EventA1, EEvent.Type1.EventA1, "测试事件广播")
